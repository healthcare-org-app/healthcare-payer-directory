"""HTTP routes for payer-directory.

Generic CRUD over the `payer_directory` table. Every mutating endpoint publishes a
...
TABLE = "payer_directory"
RESOURCE = "payer_directory"
CREATED_EVENT = ""
UPDATED_EVENT = ""
